...
<div
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-500 underline">{{ __("Dashboard") }}</a>
            @else
                <a href="{{ route('login') }}" class="text-sm text-gray-500 underline">{{ __("Log in") }}</a>
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            {{ __("Laravel's robust library of first-party tools and libraries, such as") }} <a
                                href="https://forge.laravel.com" class="underline">Forge</a>, <a
                                href="https://vapor.laravel.com" class="underline">Vapor</a>, <a
                                href="https://nova.laravel.com" class="underline">Nova</a>, {{ __('and') }} <a
                                href="https://envoyer.io"
                                class="underline">Envoyer</a> {{ __('help you take your projects to the next level. Pair them with powerful open source libraries like') }}
                            <a
                                ...
                                class="underline">Telescope</a>, {{ __('and more.') }}
                        </div>
                    </div>
                </div>
            </div>
